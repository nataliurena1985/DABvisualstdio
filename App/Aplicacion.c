...
unsigned int g_LeerModo=0;//=0 Modo desarr
...
float LeerVBat(unsigned int Modo);
float LeerVBus(unsigned int Modo);
float LeerVac(unsigned int Modo);
float LeerIac(unsigned int Modo);
float LeerVPanel(unsigned int Modo);
float LeerIPanel(unsigned int Modo);
...
float LeerVBat(unsigned int LeerModo)
{
