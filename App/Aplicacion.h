...
float LeerVBat(unsigned int LeerMode);
float LeerVBus(unsigned int LeerMode);
float LeerVac(unsigned int LeerMode);
float LeerIac(unsigned int LeerMode);
float LeerVPanel(unsigned int LeerMode);
float LeerIPanel(unsigned int LeerMode);

extern unsigned int g_LeerModo;
